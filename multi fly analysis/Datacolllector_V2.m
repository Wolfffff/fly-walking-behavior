...
%V2 uses V23 of multiple flies analysis which fixes the problem with sharp
%turns in the ring calculation and This creates additional 'turndata'
%structure array.
...
for i=1:length(genotype);
    for j=1:length(odor);
        ...
        filename = uigetfile([mainfilename ' V23*.mat'],'Select the mat file that you want to use');
        ...
        %this part was not in the previous version
        turn_data.before = radialdata.radial.turnbefore;
        turn_data.during = radialdata.radial.turnduring;
        turn_data.rings = radialdata.radial.rings;
